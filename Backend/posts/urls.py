...
from posts.views import GetEditDeletePostApiView
# from posts.views import DeletePostViewSetV1
from posts.views import PostLikeApiView
from posts.views import PostUnlikeApiView
from posts.views import GetPostsByFiltersApiView
...
urlpatterns = [
    ...
    path("v1/post/<int:post_id>", GetEditDeletePostApiView.as_view(), name="get-edit-delete-post"),
