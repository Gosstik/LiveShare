...
class Friends(models.Model):
    user = models.ForeignKey(
        User, db_column="user_id", on_delete=models.CASCADE, related_name="user"
    )
    friend = models.ForeignKey(
        User, db_column="friend_id", on_delete=models.CASCADE, related_name="friend"
    )
...
class FriendInvitation(models.Model):
    ...
    to_user = models.ForeignKey(
        User, db_column="to_user_id", on_delete=models.CASCADE, related_name="to_user"
    )
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                fields=["from_user_id", "to_user_id"], name="friendinvitations_pk"
            )
        ]
